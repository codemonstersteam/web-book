...
>Основано на принципах структурного программирования, предложенных в 1977 году авторами книги "A STRUCTURED APPROACH TO PROGRAMMING" 
Joan K. Hughes (Data Processing Consultant), Jay I. Michtom (IBM Systems Science Institute).
...
За 10-12 часов активной работы ИИ-ассистентом 
(Считаем финальную фазу. Я потратил примерно 16 часов на эксперименты, поиску подхода для работы с машиной при создании проектов)  
